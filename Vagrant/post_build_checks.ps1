...
function post_build_checks {
    ...
    $FLEET_CHECK = download -URL 'https://192.168.57.105:8412' -PatternToMatch 'Fleet for osquery'
    ...
    $VELOCIRAPTOR_CHECK = download -URL 'https://192.168.57.105:9999' -SuccessOn401
    ...
    $GUACAMOLE_CHECK = download -URL 'http://192.168.57.105:8080/guacamole' -PatternToMatch 'Apache Software'
